  ...
  const verificationSteps = [
    {
      step: 1,
      title: 'Identity & KYC',
      desc: 'Government Aadhaar and residence verification',
      status: 'VERIFIED',
      docs: 'Aadhaar Card, PAN, Voter ID (Directly Authenticated)',
      badge: 'Tier 1 Certified',
    },
    {
      step: 2,
      title: 'Cooperative Membership',
      desc: 'Affiliation with Baner Ward Workers Cooperative Collective',
      status: 'VERIFIED',
      docs: `Coop Member ID: ${currentWorker.cooperativeMemberId || 'COP-PUN-3820'}`,
      badge: 'Tier 2 Active',
    },
    {
      step: 3,
      title: 'Skill Classification',
      desc: 'Declared and practical trade skills',
      status: 'VERIFIED',
    ...
    },
    {
      ...
      desc: 'ITI / NCVT vocational trade diploma verification',
      status: 'VERIFIED',
      docs: currentWorker.certificates?.join(', ') || 'ITI Vocational Trade Diploma',
      badge: 'Tier 4 Endorsed',
    },
    {
      step: 5,
      title: 'Proficiency Assessment',
      desc: 'Standardized practical troubleshooting examination',
      status: 'VERIFIED',
      docs: `Score: ${currentWorker.proficiencyScore || 94}% (Grade A Master Tier)`,
      badge: 'Tier 5 Passed',
    },
    {
      step: 6,
      title: 'Local Society Verification',
      desc: 'Physical address & gate security verification by Society Manager',
      status: currentWorker.localVerificationStatus === 'verified' ? 'VERIFIED' : 'PENDING',
      docs: 'Green Residency Society Manager (Suresh Menon) Endorsed',
      badge: 'Tier 6 Society Pass',
    },
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-4 sm:py-8 space-y-6 sm:space-y-8 animate-fade-in">
      ...
      <div className="max-w-3xl">
        <div className="flex items-center gap-2 mb-1">
          <span className="text-xs font-bold uppercase tracking-wider text-[#324F66] bg-[#E4EDF4] px-2.5 py-0.5 rounded-md border border-[#B8CBDD]">
            Cooperative Credential Passport
          </span>
          <Badge variant="verified" size="sm">6-Tier Trust Standard</Badge>
        </div>
        <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-[#292824]">
          Worker Verification & Trust Passport
        </h1>
        <p className="text-xs sm:text-sm text-[#77736B] mt-1 leading-relaxed">
          Cooperative workers undergo a comprehensive 6-tier verification framework spanning identity, cooperative registry, vocational certifications, skill assessment, and local society management endorsement.
        </p>
      </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-xs text-[#445D3E] font-bold mt-1">
                ...
                <span>6/6 Verification Milestones Fulfilled</span>
              </div>
            </div>
          </div>

          <div className="text-right sm:border-l sm:border-[#E8E2D5] sm:pl-6">
            <span className="text-[11px] font-bold text-[#77736B] uppercase block">Proficiency Score</span>
            <span className="text-3xl font-bold font-mono text-[#445D3E]">
              {currentWorker.proficiencyScore || 94}%
            </span>
            <span className="text-[10px] text-[#77736B] block">Grade A Master</span>
          </div>
        </div>
      </Card>
      ...
      <div className="space-y-4">
        <h2 className="text-base sm:text-lg font-extrabold text-[#292824]">The 6 Verification Tiers</h2>
